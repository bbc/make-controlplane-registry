...
def _get_capi_images():
    ...
    return [
      ...
      "scaled-infra-public-docker.artifactory.labs.bbc/capi-openstack-controller:v0.8.0",
      "scaled-infra-public-docker.artifactory.labs.bbc/capi-openstack-controller:v0.8.0-bbc",
